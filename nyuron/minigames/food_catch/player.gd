...
func update_skin():
	...
	var file_hide  = folder_game + "cangrejomuelto2_minijuego2" + suffix + ".png" 
...
func _try_apply_texture(anim_name: String, path: String):
	if ResourceLoader.exists(path):
		...
		print("Skin cargada (", anim_name, "): ", path)
	else:
...
func play_damage_flash() -> void:
	...
	t.tween_property(crab_sprite, "modulate", Color.WHITE, 0.15)
...
func play_hide_animation() -> void:
	...
	# Se queda en el último frame (cangrejo muerto)
